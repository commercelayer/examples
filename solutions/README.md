...
- [dropin-basic-store-demo](./dropin-basic-store-demo) — A minimal demo that shows how to transform a plain HTML page into an enterprise-grade static commerce website, with product listing, prices, cart.
- [external-payment-gateway](./external-payment-gateway/) - A minimal TypeScript monorepo that demonstrates Commerce Layer's **asynchronous external payment gateway** flow using [Mollie](https://mollie.com).
- [giftcard-tutorial](./giftcard-tutorial) - A step by step tutorial to implement a simple page to sell digital giftcards.
checkout, customer identity, and customer portal.
